...
this.headers["Access-Control-Allow-Headers"] += ", Accept-Language, Content-Language";
...
this.headers["Access-Control-Allow-Methods"] = "GET, HEAD, POST";

this.headers["Access-Control-Expose-Headers"] = "Accept-Ranges, Content-Encoding, Content-Type, Content-Length, Content-Range, Content-Language, Cache-Control, Expires, Last-Modified, Pragma";
  }
